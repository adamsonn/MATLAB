...
i=1;
while i<length(LDP)+1
    adjmatrix(i,(length(LDP)+1))=abs(real(SingleBifucprop(optimalflowlim(i),LDP(i,1)*10^-3,LDP(i,2)*10^-3,LDP(i,3),100)));
    if i<(length(LDP)+1)/2
        adjmatrix(i,2*i)=abs(real((1-(SingleBifucprop(optimalflowlim(i),LDP(i,1)*10^-3,LDP(i,2)*10^-3,LDP(i,3),100)))/2));
        adjmatrix(i,2*i+1)=abs(real((1-(SingleBifucprop(optimalflowlim(i),LDP(i,1)*10^-3,LDP(i,2)*10^-3,LDP(i,3),100)))/2));
    else
