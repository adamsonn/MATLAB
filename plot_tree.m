...
theta_1 = branch_angle * (.4 + branch_angle_randomness * max(min(randn(), 1), -1));
theta_2 = -branch_angle * (.4 + branch_angle_randomness * max(min(randn(), 1), -1));
